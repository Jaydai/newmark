...
const CHANNELS: Channel[] = [
  { key: "--map-green", label: "Adresse de référence", defaultColor: "#2d8c5a" },
  { key: "--map-blue", label: "Comparables", defaultColor: "#0062ae" },
...
export default function ThemePicker({ onThemeChange }: { onThemeChange?: () => void }) {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {open && (
        <div className="absolute top-full right-0 mt-2 bg-white rounded-xl p-4 shadow-[0_12px_48px_rgba(0,0,0,.18),0_0_0_1px_rgba(0,0,0,.06)] min-w-[220px] z-[2500]">
